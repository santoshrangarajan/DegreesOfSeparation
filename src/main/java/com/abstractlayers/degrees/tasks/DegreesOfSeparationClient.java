 ...
 * 
 * */
public class DegreesOfSeparationClient implements Tasklet {
	
	
	 private SymbolGraphBfs symbolGraphBfs;
	 private String destination;
	 private static final Log log = LogFactory.getLog(DegreesOfSeparationClient.class);
	...
	public static void main(String []argv){
	      DegreesOfSeparationClient dos = new DegreesOfSeparationClient();     
	}
